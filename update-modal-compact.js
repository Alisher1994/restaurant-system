...
// Ищем модальное окно меню и заменяем его структуру
...
const newModalHTML = `<!-- Модальное окно для добавления/редактирования блюда -->
...
html = html.substring(0, startIndex) + newModalHTML + html.substring(endIndex + endMarker.length - 7);

fs.writeFileSync('public/admin.html', html, 'utf8');
console.log('✅ Модальное окно обновлено: компактная компоновка');
